...
---
Czy "12-factor app" to **skamielina czy nadal żywe**? Patoarchitekci odkopują ten artefakt z 2011 roku. Szymon i Łukasz sprawdzają, czy te zasady przetrwały próbę czasu w erze konteneryzacji i mikrousług.

Od _code base_ po _dev/prod parity_, prowadzący analizują każdy faktor. Kubernetes, Docker i CI/CD mieszają szyki starym regułom. Czy **health checki** i _graceful shutdown_ to brakujące ogniwa? Dowiesz się w tym odcinku!

Jeśli Twój kod pamięta czasy przed Dockerem, czas na _refaktor_! Posłuchaj i sprawdź, czy Twoja aplikacja spełnia standardy _cloud native_. Może odkryjesz, że Twój _legacy code_ jest bardziej _twelve-factor_, niż myślisz?
