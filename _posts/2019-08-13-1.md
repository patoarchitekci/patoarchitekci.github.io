...
**ŁK:** Tak i przez ten brak liczb, środki nacisku często zaczyna się w budowanie Google Skill.

**SW:** Zawsze budujemy Google Skill. To jest niesamowite, jak chcemy budując Google Skill de facto sami wrzucamy się w problemy skali Google, czyli zarządzania tym wszystkim i tak dalej. To jest przerażające jak ludzie chcą dużo na swoje barki wziąć.
