...
spotify_url: "https://open.spotify.com/episode/6mAMFz6gbPgMa2IavAbg5z"
apple_id: "https://podcasts.apple.com/us/podcast/short-78-s3-files-trivy-pwnd-codex-rescue-uncensored/id1477067604?i=1000763375145&uo=4"

# Spreaker data (technical only - for Schema.org, not user-facing)
duration: "PT28M13S"
audio_url: "https://api.spreaker.com/v2/episodes/71591556/download.mp3"
...
newsletter: |
  ...
  **"Juniorzy mają obecnie przerąbane. Nie chciałbym być w tych spodniach"** - Szymon po tym jak DHH zmienił front o 180 stopni. Łukasz dopowiada: _"to nie była ewolucja, tam musiała nastąpić rewolucja, jeżeli on wyraził taką opinię na głos."_ W odcinku #191 Short przelatujemy przez S3 Files z POSIX-em, supply chain attacki na Trivy i PyPI, plugin OpenAI dla Claude Code i lokalną Gemmę 4. 🎯
  
  Spoiler: nazwa skilla od OpenAI dla Claude Code'a brzmi "Codex Rescue". Bo nawet Opus potrzebuje ratunku. 🔥
  
  ---
  
  **W tym mailingu:**
  - 🎉 **Konferencja Pato #200 - strona, agenda i bilety!**
  - 🎙️ Odcinek #191 Short: S3 Files, Trivy Pwnd, Codex Rescue, Uncensored Gemma, DHH o AI Coding
  - 🎓 Szkolenie: Agentic AI the Hard Way - **zostało tylko 5 miejsc!**
  ...
  **"Senior engineers benefit from AI a lot more than juniors"** - DHH zmienił front o 180 stopni i ogłasza, że Shape Up jest do przepisania. Szymon idzie dalej: _"juniorzy mają obecnie przerąbane."_ Ewolucja czy rewolucja? 💀
  
  **Kluczowe wątki:**
  
  #### 🤖 AWS S3 Files - POSIX na S3
  S3 dorobił się interfejsu plikowego zgodnego z POSIX-em. Brzmi imponująco, dopóki nie odkryjesz minutowego stage and commit i konfliktów rozwiązywanych przez lost and found + CloudWatch. Łukasz: _"To nie jest takie big thing jakby się o tym trochę pomyślało."_ Lazy hydration metadanych ciekawe, cennik AWS-a - jak zwykle będzie ciekawy.
  
  #### ⚠️ Kącik supply chain - Trivy zhackowane
  **Trivy** zhackowane przez `pull_request_target` w GitHub Actions - fork wykonywany z secretami oryginalnego repo. 4 podatne obrazy, najdłuższy widoczny przez 12h. Sami to polecamy. 💀
  
  Na PyPI złośliwy pakiet **LightLLM** zbiera git configi, konfiguracje Kubernetes i portfele krypto. Wchodzi na klaster K8s i podmienia obrazy żeby się rozpowszechniać. A **Ingress NGINX** po archiwizacji łapie pierwszą podatność na 8,8 punkta. Mówiliśmy.
  
  #### 💰 Claude Mythos i marketing pod IPO
  Anthropic ogłasza model do wykrywania podatności - 63% na CyberGym (vs 66% Opusa). Dostępny dla 40 dużych firm, szczegóły zerowe. Łukasz: _"Naładowaliśmy tam tyle mocy obliczeniowej, że inferencing by nam się nie spiął."_ Zbliżają się IPO OpenAI i Anthropica - marketing leci pełną parą.
  
  #### 🔥 Codex Rescue - plugin OpenAI dla Claude Code
  OpenAI wydał oficjalny plugin do Claude Code z dwoma skillami: **review** (krytyczne review kodu) i **rescue** (naprawia to, czego Opus nie potrafi). Plus hooki wymuszające review przed commitem. Łukasz: _"Mówię poważnie, tutaj nie ma żartu."_ Cross-review między modelami robi robotę.
  
  #### 🎯 DHH zmienia front o 180 stopni
  DHH porównuje pracę z wieloma agentami do _"noszenia mech suite'a"_. CLI jako ostateczny interfejs dla AI w kodowaniu (filozofia unixowa zwalidowana). Ostrzega przed burnoutem z dopaminowej pętli AI. I deklaruje: **Shape Up jest do przepisania**. To nie ewolucja - to rewolucja.
  
  #### 🤖 Gemma 4 lokalnie + wersja niecenzuralna
  Google wydał Gemma 4 - jakość lokalnie zaskoczyła Łukasza. Wersje 2B i 4B chodzą nawet na telefonie (Edge Gallery). Community w kilka tygodni zrobił **abliteration** - refusal wycięty chirurgicznie, -2% na MMLU, 3,2% refusal rate w JailbreakBench.
  
  Plus architektura agentów od Anthropica: planer + generator + ewaluator. Solo agent: 20 min, $9, nie działa. Pełny harness: 6h, $200. Robi robotę. ⚡
  
  📺 [YouTube](https://www.youtube.com/watch?v=-aHQ4CjLkgU)
  🌐 [Strona odcinka](https://patoarchitekci.io/191)
  
  ---
  
  ### 🎓 Szkolenie: Agentic AI the Hard Way - zostało tylko 5 miejsc! ⚠️
  
  **Prowadzący:** Łukasz Kałużny
  **Termin:** 26 maja 2026 | 9:30-17:00
  
  Budowanie własnego agenta AI od podstaw **bez frameworków** - wzorzec ReAct, pętla agenta, function calling i orkiestracja. Hands-on: zbudujemy działającego agenta, którego rozumiesz od środka. W odcinku #191 Anthropic pokazał architekturę trzech agentów (planer + generator + ewaluator) - tu zbudujesz to samodzielnie i zrozumiesz dlaczego dobra pętla robi różnicę między $9/nic-nie-działa a $200/pełny-rezultat. 😉
  
  **Zostało tylko 5 miejsc** - jak chcesz wskoczyć, nie czekaj. 🔥
...
links:
  ...
  - title: "high-vulnerability CVE (CVE-2026-4342) has been identified in ingress-nginx"
  ...
  - title: "Twórca Redis i AI-Assisted Development"
