...
description: "Technology Radar Vol. 34 - agenci AI tylko dla deweloperów, codebase cognitive debt i coding agents. Sprawdź co Thoughtworks mówi o przyszłości kodu."
...
spotify_url: "https://open.spotify.com/episode/0Uz8vLHh5kv9SZqyYUfDch"
apple_id: "https://podcasts.apple.com/nz/podcast/technology-radar-vol-33-review/id1477067604?i=1000765119198"

# Spreaker data (technical only - for Schema.org, not user-facing)
duration: "PT24M18S"
audio_url: "https://api.spreaker.com/v2/episodes/71773559/download.mp3"
...
newsletter: |
  ...
  **"Obecnie taczki mamy pełne, biegamy, ale budujemy nie do końca to, co powinniśmy budować"** - Szymon o codebase cognitive debt. Łukasz dorzuca: _"Budujemy budynek obok."_ W odcinku #192 robimy przegląd Technology Radar Vol. 34 od Thoughtworksa - i okazuje się, że Łukasz ma _what the fuck_, bo ktoś przeskanował mu Todoistę. 🎯
  
  Spoiler: agenci biznesowi - hype poprzedniej edycji - wyparowali. Zostali wyłącznie agenci dla deweloperów. 💀
  
  ---
  
  **W tym mailingu:**
  - 🎉 **Konferencja Pato #200 - bilety!**
  - 🎙️ Odcinek #192: Technology Radar Vol. 34 Review
  - 🚀 Powered by Protopia: FinOps to nie narzędzie
  ...
  **16 czerwca 2026 | Warszawa, Sky Hall - Twarda 18 | 8:00 - 17:00**
  ...
  Pełna agenda, sylwetki prelegentów, opisy prelekcji i co jest w cenie biletu - wszystko w jednym miejscu. 🎯
  ...
  **Prelekcje:**
  ...
  Networking i lunch w cenie biletu. 359 zł netto.
  ...
  **"Miałem what the fuck, czy ktoś przeskanował mojego Todoista?"** Łukasz po lekturze nowego radaru - bo prawie wszystko z niego pokrywa się z ich własnym stosem i backlogiem. Szymon: _"Obserwują Cię."_ Najdłużej żyjąca seria Patoarchitektów wraca z diagnozą stanu rynku. 🎯
  
  **Kluczowe wątki:**
  
  #### 💀 Codebase cognitive debt
  Generujemy więcej kodu niż jesteśmy w stanie zrozumieć i użyć. Szymon: _"Taczki mamy pełne, biegamy, ale budujemy nie do końca to, co powinniśmy."_ Łukasz: _"Budujemy budynek obok."_ Velocity wygląda fenomenalnie - tylko kod nikogo nie obchodzi.
  
  #### 🤖 Agenci biznesowi wyparowali
  Hype poprzedniej edycji - zniknął. Radar skupił się WYŁĄCZNIE na agentach dla deweloperów. Szymon: _"Agenci powstają jak Notebooki Jupyterowe. Jednorazówka, nigdy niemodyfikowane."_ Nikt nie myśli o utrzymaniu.
  
  #### ⚠️ Mit managerski 2026
  Łukasz: _"Jak usłyszycie, że manager mówi, że coś się samo uczy na naszych przykładach, weźcie wyrzućcie mu komputer przez okno."_ Agent biznesowy się NIE uczy. Coding agent z memory - to inna sprawa.
  
  #### 🎯 Co warto adoptować
  Feedback sensors, sandboxed execution, mapping code smells to refactoring techniques i Spec Driven Development (GitHub Spec Kit). Plus Claude Code w adopcie, small language models z Gemmą na telefonie i DeepEval w codziennym użyciu.
  
  #### 🔥 Co testowaliśmy i wyrzucamy
  Token-Oriented Object Notation - Łukasz przetestował: _"Sprawdziłem, wyrzućcie, nie używajcie - obiecany wzrost jakości nie istnieje."_ Oszczędność tokenów to ściema.
  
  #### 📊 Wymiana pokoleniowa w Thoughtworks
  Fowler zniknął z creditsów. _"Hold"_ zamieniono na _"caution"_. Szymon: _"Zespół jest młody. Albo my jesteśmy starzy."_
  
  Plus kontrowersyjna opinia Szymona na koniec. 🎧
  
  ---
  
  ### 🚀 Powered by Protopia: FinOps to nie narzędzie - jak mądrze wdrożyć go jako proces
  
  **"FinOps to proces, którego celem nie są oszczędności, tylko widoczność. Oszczędności są efektem ubocznym."** - Szymon Warda. 🎯
  
  Kupisz narzędzie do FinOps i problemy znikną? Magiczny proszek jeszcze nikogo nie uzdrowił. Mikołaj Szczerbicki rozmawia z Szymonem Wardą o tym, jak naprawdę wdrożyć FinOps:
  
  ✅ Widoczność daje kontrolę - oszczędności pojawiają się przy okazji
  ✅ Typowe pułapki: rozproszeni dostawcy, niekontrolowane licencje, długi ogon kosztowy
  ✅ Dlaczego dorzucanie pracy zespołom kończy się efektem jojo
  ✅ Faza sprzątania - inwentaryzacja, tagi, konsolidacja zasobów
  ✅ Governance - budżety, polityki i automatyzacja zamiast słowa harcerza
  ✅ Marchewka zamiast kijka - jak zachęcić zespoły do dobrych praktyk
  ✅ Pętla zwrotna - proces, który sam się uzdrawia i ewoluuje z organizacją
  ✅ Wdrożenie w 3 fazach: 2-3 miesiące, pół roku, kultura na zawsze
  
  📺 [YouTube](https://youtu.be/6wnDDifMWfU)
  🎧 [Spotify](https://open.spotify.com/episode/46qMptVMHE4ShxEAtfMWif)
  ...
  **Termin:** 17-18 i 24-25 listopada 2026, 9:00-13:00 (4 dni)
  ...
  🔥 **Pierwsze miejsca już poszły** - po weekendzie majowym pewnie zaczną znikać kolejne. Jak chcesz wskoczyć, nie czekaj.
