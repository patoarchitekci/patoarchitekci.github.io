...
spotify_url: "https://open.spotify.com/episode/3IKF6Pp472lhZ57Jiko1p9"
apple_id: "https://podcasts.apple.com/us/podcast/context-switching-brain-fry-i-praca-z-agentami/id1477067604?i=1000760613730&uo=4"

# Spreaker data (technical only - for Schema.org, not user-facing)
duration: "PT16M40S"
audio_url: "https://api.spreaker.com/v2/episodes/71212161/download.mp3"
...
newsletter: |
  Cześć! **"Żyję w bardzo kontrolowanym chaosie na co dzień"** - Łukasz po tym jak agent zjadł mu darmowe minuty na GitHub Actions. W odcinku #189 Łukasz i Szymon kłócą się o to, czy AI agents nas wykańczają czy po prostu źle z nimi pracujemy. BCG potwierdza brain fry, a problem jest znany od lat 50. - w fabrykach nazwali to Ironies of Automation. 💀
  
  Spoiler: Szymon zna ludzi, którzy puszczają na produkcję kod w pełni wygenerowany przez AI. Bez code review.
  
  ---
  
  **W tym mailingu:**
  - 🎉 **Konferencja Pato #200 - pełna agenda!**
  - 🎙️ Odcinek #189: Context switching, Brain Fry i praca z agentami
  - 🚀 Powered by Protopia: Observability w Działaniu
  ...
  **16 czerwca 2026 | Warszawa, SkyHall - Twarda 18 | 9:00 - 17:00**
  
  Mamy zamkniętą agendę! 🎊
  ...
  **Prelekcje:**
  ...
  Plus nienagrywany keynote z krótkim Q&A i na zamknięcie - nagrywamy **200. odcinek na żywo** ze wszystkimi prelegentami 🎙️
  ...
  **"Jak sobie popatrzysz na profile ryzyka w niektórych miejscach, to jest proszenie się o zabójstwo."** Łukasz po tym jak BCG opublikowało raport o zjawisku "brain fry" przy pracy z AI. I uwaga - Łukasz, który od lat szydzi z raportów konsultingowych, po raz pierwszy się z jednym zgadza. 😅
  
  **Kluczowe wątki:**
  
  #### 🤖 Brain fry ma korzenie w latach 50.
  Problem został nazwany Ironies of Automation i vigilance decrement - spadek czujności spowodowany nadzorem. Teraz zamiast linii produkcyjnej masz VSCode i agenta, który potrafi polecieć w zupełnie złą stronę.
  
  #### 🔥 Dark code factories
  Szymon zna systemy produkcyjne w pełni wygenerowane przez AI - bez code review. Łukasz mówi: mit. Kto ma rację?
  
  #### 💀 Łukasz się sparzył
  Agent wygenerował CI/CD, nie ogarnął filtrów i zjadł darmowe minuty na GitHub Actions. _"Pierdoła, ale była."_
  
  #### 🎯 Dwa podejścia do context switching
  Łukasz ogranicza się do 2-3 kontekstów. Szymon operuje 4 wirtualnymi desktopami i daje agentowi instrukcję: _"commit, deploy, verify and fix all the bugs."_
  
  Czemu kończy się na "to nie choroba, to czterdziestka"? 🎧
  
  📺 [YouTube](https://youtube.com/watch?v=Dd4xFj2dDd4)
  🎧 [Spotify](https://open.spotify.com/episode/3IKF6Pp472lhZ57Jiko1p9)
  
  ---
  
  ### 🚀 Powered by Protopia: Observability w Działaniu
  
  **Wiesz już czym jest observability, ale ile to kosztuje i jak wdrożyć?** DataDog i Dynatrace liczą per seat - przy 50 osobach to 6-7 cyferek rocznie. Grafana stack? Zero limitów, zero licencji.
  
  Szymon Warda i Mikołaj Szczerbicki przechodzą od teorii do praktyki - plan wdrożenia fazami, live demo RED metrics i eBPF profiling z narzutem 1-3%:
  
  ✅ Kiedy observability ma sens - od małej+ organizacji
  ✅ Koszty licencji per seat vs Grafana stack bez limitów
  ✅ Plan wdrożenia fazami - inwentaryzacja → Grafana → Alloy → platforma → standardy
  ✅ Demo RED metrics - Request/Error/Duration i root cause analysis
  ✅ eBPF profiling - 1-3% narzutu vs 5-10% u komercyjnych, zero zmian w kodzie
  ✅ Integracja z Zabbix, ELK - ewolucja, nie rewolucja
  
  **Dla kogo?** Managerów IT rozważających observability. Zespołów DevOps i SRE szukających planu wdrożenia. CTOów porównujących koszty komercyjnych narzędzi vs open source.
  
  📺 [YouTube](https://youtu.be/7IBD4y_kuqw)
  🎧 [Spotify](https://open.spotify.com/episode/1So0IwKzqa1NV1B4BpCyyj?si=S9daF2cTRSSgsTjq3S4GkA)
  ...
  **Termin:** 26 maja 2026 | 9:30-17:00
  ...
  Budowanie własnego agenta AI od podstaw **bez frameworków** - wzorzec ReAct, pętla agenta, function calling i orkiestracja. Hands-on: zbudujemy działającego agenta, który rozumiesz od środka. W odcinku #189 mówiliśmy o brain fry i dark code factories - tu dowiesz się jak budować agentów, które robią to co chcesz. 😉
...
links:
  ...
  - title: "Agentic AI The Hard Way - Szkolenie"
    url: "https://patoarchitekci.io/szkolenia/agentic-ai-the-hard-way/"
  - title: "When Using AI Leads to Brain Fry - BCG"
    url: "https://www.bcg.com/news/5march2026-when-using-ai-leads-brain-fry"
  - title: "Vigilance Decrement - NCBI"
