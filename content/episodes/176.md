...
date: 2026-01-09T08:00:00+02:00
episode: "176"
...
spotify_url: "https://open.spotify.com/episode/1l2S5AjRSzeY766KcAKkne"
apple_id: "https://podcasts.apple.com/us/podcast/short-75-ibm-kupuje-confluent-skills-vs-agents-wal-patterns/id1477067604?i=1000744410122&uo=4"

# Spreaker data (technical only - for Schema.org, not user-facing)
duration: "PT32M54S"
audio_url: "https://api.spreaker.com/v2/episodes/69350574/download.mp3"
...
newsletter: |
  # Newsletter Patoarchitekci #176
  
  Cześć! **Noworoczny Short** - pierwszy w 2026 roku! 🎉 Łukasz i Szymon wracają po przerwie świątecznej z porcją newsów technologicznych, które nie czekały. Postanowienia noworoczne? _"Mniej YAML-a, więcej Postgresa"_ - jak zwykle nierealne.
  
  ---
  
  **W tym mailingu:**
  - 🎙️ Noworoczny Short #176 - newsy technologiczne
  - 🎉 Konferencja Pato #200 - bilety już dostępne!
  - 🚀 Powered by Protopia: API Management w PZU
  - 🎓 Nadchodzące szkolenia
  
  ---
  
  ### 🎙️ Short #176: Noworoczny przegląd newsów tech
  
  **IBM kupuje Confluenta** - kolejny ruch po RedHacie i Hashicorpie. Łukasz: _"Kupują rzeczy, które są ciężko licencjonowane."_ **Kafka is becoming a commodity** - Szymon dodaje: _"To się już stało."_ A moda na budowanie wszystkiego na Kafce przygasa. 🎯
  
  **Nowy hype: WAL jako osobny serwis** - Netflix zrobił z Write-Ahead Log uniwersalną usługę. Łukasz ostrzega: _"Jak nie jesteś drugim Netflixem, nie powinieneś w ogóle myśleć, że coś takiego jest."_ Podobnie jak CDC - kolejny buzzword w świecie event streamingu.
  
  **MinIO przechodzi w maintenance mode** - najpopularniejsze self-hosted S3-compatible storage kończy aktywny rozwój. Co dalej z open source'owymi projektami enterprise'owymi?
  
  **Anthropic Skills** - dynamicznie ładowane zip-y z Markdownem zamiast subagentów. Szymon: _"Fajna rzecz, rozwiązuje realne problemy adopcji."_ Idzie też standaryzacja **Agents.md** w ramach **CNCF**. Plus: Anthropic przejął **Buna** (runtime TypeScript/JavaScript).
  
  **Chainguard** przejmuje porzucone projekty open source jak **Ingress NGINX** - szczytna idea czy ryzykowna centralizacja?
  
  **Raport GitClear**: 10x wzrost duplikacji kodu przez AI. Szymon: _"Nie uważam, żeby to była tragedia."_ Dyskusja o tym, czy duplikacja kodu jest zawsze zła, czy czasem wręcz pomocna.
  
  **Instacart** porzuca **Elastica** na rzecz **Postgresa** z indeksami **GIN** - full-text search na PostgreSQL? Tak, to działa i to dobrze!
  
  **Mac Studio** z **RDMA** przez **Thunderbolt 5** = 1,5TB VRAM na czterech maszynach. Najlepszy sprzęt do domowego hostowania modeli? ⚠️
  
  📺 [YouTube](https://youtube.com/watch?v=LP77-Zq1uPk)
  🎧 [Spotify](https://open.spotify.com/show/4xTqydkPwN7DkHLRUu8OaP)
  🎧 [Apple Podcasts](https://podcasts.apple.com/podcast/id1477067604)
  ...
  **Partner:** Protopia
  ...
  ### 🚀 Powered by Protopia: Od API Management do AI Agents - Case Study PZU
  
  **Jak wyjść z platformy SOA, która działała 15+ lat?** Jak wdrożyć API Management w branży regulowanej? I jak przygotować infrastrukturę na agentów AI, zanim wszyscy o nich mówili?
  
  Marek Grabarz rozmawia z Krzysztofem Radzimowskim z PZU:
  
  ✅ Transformacja z SOA do nowoczesnej platformy integracyjnej
  ✅ Self-hosted gateway - compliance bez kompromisów
  ✅ Samoobsługa dla developerów - koniec z byciem wąskim gardłem
  ✅ 100+ API w portfelu - jak zbudować efekt skali
  ✅ AI Gateway i MCP - przygotowanie na agentów
  
  **31 minut case study** z realnego wdrożenia w największej firmie ubezpieczeniowej w Polsce.
  
  📺 [YouTube](https://youtu.be/kMOE4XaqZF8)
  🎧 [Spotify](https://open.spotify.com/episode/1JiCp5D3bhQ5cQpcBThcHG)
  ...
  **Luty 2026:**
  ...
  - Agentic AI the Hard Way - Łukasz (24.02 | 9:30-17:00)
  ...
  **Kwiecień 2026:**
  ...
  - Architektura 101 - Łukasz (14, 15, 21, 22.04 | 9:00-13:00)
