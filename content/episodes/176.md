...
newsletter: |
  ...
  Cześć! Dzisiaj mięsisty temat - dostaliśmy pytanie od słuchacza o wdrożenie chmury at scale i postanowiliśmy rozprawić się z mitem, że "greenfield już nie istnieje". Spoiler: istnieje, ale wymaga zupełnie innego podejścia. Do tego bilety na konferencję #200 już w sprzedaży (strona dojdzie... kiedyś 😅) i świeży odcinek Powered by Protopia o API Management w PZU.
  
  ---
  
  **W tym mailingu:**
  - 🎙️ Nowy odcinek: Chmura at scale - Greenfield vs Brownfield
  - 🎉 Konferencja Pato #200 - bilety już dostępne! (strona... dojdzie 😅)
  - 🚀 Powered by Protopia: API Management w PZU
  - 🎓 Nadchodzące szkolenia
  
  ---
  
  ### 🎙️ Odcinek #176: Chmura at scale - Greenfield vs Brownfield
  
  **"At scale to nie technologia - to role, obszary i ownership. Bez tego governance się rozpadnie."**
  
  Dostaliśmy pytanie od słuchacza: _"Jak wdrożyć chmurę w dużej skali? Governance, security, control policies, CSPM, sieć, identity, wspólne komponenty... Od czego zacząć?"_
  
  I od razu rozprawiamy się z mitem: **"greenfield już nie istnieje"**. Nieprawda - właśnie ofertowaliśmy pełne wdrożenie Landing Zone dla dużego klienta z sektora regulowanego. Greenfield istnieje, ale wymaga innego podejścia niż "wyklikam sobie w portalu".
  
  **W odcinku:**
  - Kiedy Landing Zone staje się "at scale"? (hint: gdy two pizza team przestaje ogarniać)
  - RACI/DACI - role PRZED technologią
  - Greenfield: kolejność wdrożenia (Governance → Sieć → Identity → Policies)
  - Brownfield: jak sprzątać bez zatrzymywania produkcji
  - Policy-driven (deny) vs moduły Terraform - co jest paved path?
  - Pain in the ass: subskrypcje + sieć (wybierz ból, który umiesz zarządzać)
  
  **Kluczowa lekcja:** _"Często zaczynamy od dupy strony - od technologii, a nie od standardów. Będziemy self-service'ować płatki śniegu i umrzemy przez tysiąc cięć."_
  ...
  **Partner:** Protopia
  ...
  _PS. Strona konferencji jeszcze nie dojechała - będzie w ciągu najbliższych dwóch tygodni. Ale bilety już można kupować!_ 😅
