...
intro: |
  ...
  **Human in the loop** to nie opcja - to konieczność. Szymon ostrzega o **vibekodingu**: _„Gwarantuję, że będzie ciśnienie, żeby ten kod trafił na produkcję."_ Łukasz porównuje z **Power Platform**: _„Żyje sobie w swojej niszy. Nigdy nie weszła na duże systemy."_ To samo czeka **vibe coding** - Make.com wylatuje z budżetu na rzecz vibekodowanych rozwiązań, ale **human in the loop** zostaje. ⚠️
...
links:
  ...
  - title: "Idea: Pod-level probes or exclude some containers from pod readiness"
    url: "https://github.com/kubernetes/kubernetes/issues/127276"
