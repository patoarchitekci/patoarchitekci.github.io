...
### 📻 Polecany odcinek: #141 Prosto i praktycznie wyjaśniamy: Kontenery


**"Kontenery to nie tylko Docker"** - ale czy naprawdę rozumiesz, co się dzieje pod spodem? 🤔 Radek z Discorda poprosił o wyjaśnienie kontenerów **prosto i praktycznie**, więc Szymon i Łukasz wzięli się za rozbiórkę całego stosu technologicznego!

**Z naszej rozmowy dowiesz się:**

- **Historia konteneryzacji**: Od **chroota** w Unixie z 1979 roku przez **FreeBSD Jail** aż po współczesne rozwiązania

- **Anatomia docker run**: Jak **ContainerD**, **runc** i **OCI** współpracują z kernelem Linuxa

- **Tajemnice izolacji**: Czemu **namespaces** i **cgroups** to podstawa bezpieczeństwa kontenerów

- **Warstwa po warstwie**: Jak działa **OverlayFS** i dlaczego **multi-stage build** to nie tylko buzzword

**Praktyczny lifehack:** Możesz zbudować kontener bez Dockera - wystarczy bash i API kernela! 🔧

**Ciekawostka z odcinka:** _"Docker nie wymyślił nic nowego, tylko przykrył bardzo przyjemnym command linem LXC"_ - czasem najlepsze innowacje to dobry UX dla istniejącej technologii.

Sprawdź, czy po tym odcinku przestaniesz używać Dockera jak czarnej skrzynki i zaczniesz rozumieć, co naprawdę się dzieje w Twoim **kubelet'cie**! 🚀
...
➡️ [Strona odcinka](https://patoarchitekci.io/141/)
